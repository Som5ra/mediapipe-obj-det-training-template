...
from mediapipe_model_maker.python.core.data import cache_files
...
def _bbox_data_to_feature_dict(data):
  ...
  if not data['xmin']:
    bbox_feature_dict = {
        'image/object/bbox/xmin': tfrecord_lib.convert_to_feature([0.0]),
        'image/object/bbox/xmax': tfrecord_lib.convert_to_feature([0.0]),
        'image/object/bbox/ymin': tfrecord_lib.convert_to_feature([0.0]),
        'image/object/bbox/ymax': tfrecord_lib.convert_to_feature([0.0]),
        'image/object/class/label': tfrecord_lib.convert_to_feature([0]),
    }
  else:
    bbox_feature_dict = {
