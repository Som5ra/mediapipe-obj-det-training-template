...
class Preprocessor(object):
  ...
  def __call__(
    ...
    if is_training:
      image = preprocess_ops.random_brightness(image, min_limit = 1, max_limit = 1.3)
      image = preprocess_ops.random_contrast(image, contrast = 0.15)
      image = preprocess_ops.random_saturation(image, saturation = 0.15)
      image, boxes, _ = preprocess_ops.random_horizontal_flip(image, boxes)
      image, boxes, _ = preprocess_ops.random_vertical_flip(image, boxes)
      image, boxes, _ = preprocess_ops.rotate_90(image, boxes)
